...
○ D) Fourth option to complete multiple choice
    ...
    with tab3:
        ...
        if st.session_state.chunks:
            ...
            {
                "id": 3,
                "question": "What scientific principle explains why objects fall toward Earth?",
                "options": [
                ...
                "context": "Gravity is a fundamental force that attracts objects with mass toward each other. Earth's gravity pulls objects toward its center with an acceleration of approximately 9.8 m/s².",
                "explanation": "Gravitational force, as described by Newton's law of universal gravitation, explains why objects fall toward Earth. This force is proportional to the masses of objects and inversely proportional to the square of the distance between them."
            },
            {
                "id": 4,
                "question": "Which historical period is known as the 'rebirth' of learning and culture?",
                "options": [
                    "Medieval Period",
                    "Renaissance Era",
                ...
                "context": "The Renaissance (14th-17th centuries) was a period of renewed interest in classical learning, art, and science in Europe. It marked the transition from medieval to modern times with emphasis on humanism and individual achievement.",
                "explanation": "The Renaissance, meaning 'rebirth' in French, marked a period of cultural, artistic, and intellectual revival in Europe after the Middle Ages. It featured great artists like Leonardo da Vinci and Michelangelo."
            },
            {
                "id": 5,
                ...
                "correct_answer": 1,
                "source": "Literature_Guide.pdf",
                "context": "A simile is a figure of speech that compares two different things using the words 'like' or 'as' to highlight similarities. For example: 'She runs like the wind' or 'He is as brave as a lion.'",
                "explanation": "A simile explicitly compares two things using 'like' or 'as', while a metaphor makes an implicit comparison without these words. Similes help create vivid imagery in writing."
            },
            {
                "id": 6,
                "question": "In Python programming, what data structure stores items in key-value pairs?",
                "options": [
                    "List",
                    "Tuple",
                    "Dictionary",
                ...
                "context": "A dictionary in Python is a collection of key-value pairs where each key is unique. It's defined using curly braces {} and allows fast lookup of values using their corresponding keys.",
                "explanation": "Dictionaries are Python's implementation of hash tables or associative arrays. They provide O(1) average time complexity for lookups and are essential for mapping relationships between data."
            },
            {
                "id": 7,
                ...
                "correct_answer": 2,
                "source": "Chemistry_Fundamentals.pdf",
                "context": "Gold is a precious metal with the chemical symbol Au, derived from the Latin word 'aurum'. It has atomic number 79 and is known for its resistance to corrosion and excellent conductivity.",
                "explanation": "Gold's symbol 'Au' comes from its Latin name 'aurum'. It's a transition metal that has been valued throughout history for jewelry, currency, and industrial applications."
            },
            {
                "id": 8,
                "question": "Which war is considered the first 'world war' in terms of global scope?",
                "options": [
                    "Napoleonic Wars",
                    "Seven Years' War",
                    "World War I",
                ...
                "context": "The Seven Years' War (1756-1763) involved major European powers and was fought on multiple continents including Europe, North America, the Caribbean, India, and the Philippines.",
                "explanation": "While World War I was the first to be called a 'World War', historians often consider the Seven Years' War the first true global conflict due to its worldwide scope and involvement of major powers across multiple continents."
            },
            {
                "id": 9,
                ...
                "context": "HTML (HyperText Markup Language) is the standard markup language for creating web pages. It describes the structure of web content using elements and tags.",
                "explanation": "HTML stands for HyperText Markup Language. It's the foundation of web development, providing the structure and content of web pages through a system of tags and elements."
            },
            {
                "id": 10,
                ...
                "context": "Mitochondria are organelles found in most eukaryotic cells. They generate most of the cell's ATP (adenosine triphosphate) through cellular respiration, providing energy for cellular processes.",
                "explanation": "Mitochondria are called the 'powerhouse of the cell' because they produce ATP, the energy currency of cells. They have their own DNA and are thought to have evolved from ancient bacteria."
            },
            {
                "id": 11,
                "question": "What is the result of 2³ + 4² in mathematics?",
                "options": [
                    "20",
                    "24",
                    "18",
                ...
                "correct_answer": 1,
                "source": "Mathematics_Advanced.pdf",
                "context": "Exponents represent repeated multiplication. 2³ means 2 × 2 × 2 = 8, and 4² means 4 × 4 = 16. When adding these results: 8 + 16 = 24.",
                "explanation": "2³ = 2 × 2 × 2 = 8, and 4² = 4 × 4 = 16. Therefore, 2³ + 4² = 8 + 16 = 24. Understanding exponents is fundamental for algebra and higher mathematics."
            },
            {
                "id": 12,
                ...
                "correct_answer": 1,
                "source": "CSS_Fundamentals.pdf",
                "context": "CSS (Cascading Style Sheets) uses the 'color' property to set the foreground color of text content. This is different from 'background-color' which sets the background.",
                "explanation": "The 'color' property in CSS is used to set the text color of elements. For example: 'color: blue;' or 'color: #ff0000;' for red text."
            },
            {
                "id": 13,
                ...
                "correct_answer": 2,
                "source": "Geography_World_Capitals.pdf",
                "context": "Canberra is the capital city of Australia, located in the Australian Capital Territory. It was specifically planned and built to be the capital, chosen as a compromise between Sydney and Melbourne.",
                "explanation": "Canberra is Australia's capital city. Many people incorrectly think it's Sydney (largest city) or Melbourne (cultural capital), but Canberra was specifically designed as the capital in 1908."
            },
            {
                "id": 14,
                ...
                "correct_answer": 1,
                "source": "JavaScript_Array_Methods.pdf",
                "context": "JavaScript arrays have several methods for manipulation. The push() method adds one or more elements to the end of an array and returns the new length of the array.",
                "explanation": "The push() method is used to add elements to the end of a JavaScript array. For example: arr.push('newItem') adds 'newItem' to the end of the array 'arr'."
            },
            {
                "id": 15,
                ...
                "context": "Water is a chemical compound consisting of two hydrogen atoms bonded to one oxygen atom. Its molecular formula is H₂O, making it one of the most important compounds for life.",
                "explanation": "Water's chemical formula is H₂O, indicating two hydrogen atoms and one oxygen atom. This simple molecule is essential for all known forms of life on Earth."
            },
            {
                "id": 16,
                ...
                "correct_answer": 1,
                "source": "Literature_Classic_Novels.pdf",
                "context": "George Orwell wrote '1984', a dystopian novel published in 1949. The book explores themes of totalitarianism, surveillance, and the manipulation of truth in a fictional future society.",
                "explanation": "George Orwell (Eric Blair) wrote '1984', one of the most influential dystopian novels. It introduced concepts like 'Big Brother', 'doublethink', and 'thoughtcrime' that remain relevant today."
            },
            {
                "id": 17,
                ...
                "context": "Jupiter is the largest planet in our solar system, with a mass greater than all other planets combined. It's a gas giant composed primarily of hydrogen and helium.",
                "explanation": "Jupiter is the largest planet in our solar system, with a diameter of about 143,000 kilometers. It's so large that all other planets could fit inside it with room to spare."
            },
            {
                "id": 18,
                ...
                "correct_answer": 1,
                "source": "Modern_History_WWII.pdf",
                "context": "World War II ended in 1945 with the surrender of Japan in September, following the atomic bombings of Hiroshima and Nagasaki and the Soviet invasion of Manchuria.",
                "explanation": "World War II ended in 1945. Germany surrendered in May 1945, and Japan surrendered in September 1945, officially ending the war that had lasted six years."
            },
            {
                "id": 19,
                ...
                "correct_answer": 0,
                "source": "Database_Management_SQL.pdf",
                "context": "SQL (Structured Query Language) is a programming language designed for managing and manipulating relational databases. It's used to create, read, update, and delete data.",
                "explanation": "SQL stands for Structured Query Language. It's the standard language for relational database management systems, used by databases like MySQL, PostgreSQL, and SQL Server."
            },
            {
                "id": 20,
                ...
                "context": "The speed of light in a vacuum is a fundamental physical constant, approximately 299,792,458 meters per second, which equals about 300,000 kilometers per second or 186,000 miles per second.",
                "explanation": "The speed of light in vacuum is exactly 299,792,458 m/s by definition. This can also be expressed as approximately 300,000 km/s or 186,000 miles/s - all answers are correct representations."
            }
        ]

        # Display each sample question
        for i, question in enumerate(sample_quiz_questions):
            ...
            ">
                <div style="
                    ...
                    text-align: center;
                ">
                    <h3 style="margin: 0; color: white;">📝 Question {question['id']} of 20</h3>
                </div>
                ...
                <p style="color: #667eea; margin-bottom: 1rem;">
            ...
            # Submit and result handling
            col1, col2 = st.columns([1, 3])

            with col1:
                if st.button(f"Submit Q{i+1}", key=f"submit_sample_{i+1}"):
                    if user_answer:
            ...
            if st.session_state.sample_quiz_submitted.get(i+1, False):
                ...
                # Reset button
                with col2:
                    if st.button(f"Try Again Q{i+1}", key=f"reset_sample_{i+1}"):
        ...
        # Subject breakdown and overall quiz summary
        if st.session_state.sample_quiz_submitted:
            ...
            subjects = {
                "Mathematics": [1, 11],
                "Programming": [2, 6, 14, 19],
                "Science": [3, 7, 10, 15, 17, 20],
                "History": [4, 8, 18],
                "Literature": [5, 16],
            ...
            subject_performance = {}
            for subject, question_ids in subjects.items():
                subject_correct = 0
                subject_total = 0
                for q_id in question_ids:
                    if q_id in st.session_state.sample_quiz_submitted:
                        subject_total += 1
                        answer = st.session_state.sample_quiz_answers.get(q_id, "")
                        ...
                        if answer == correct_option:
                            ...
                            correct_count += 1
                if subject_total > 0:
                    subject_performance[subject] = (subject_correct, subject_total)

            # Count remaining correct answers for overall total
            for q_id, answer in st.session_state.sample_quiz_answers.items():
                if q_id not in [q for sublist in subjects.values() for q in sublist]:
                    question = sample_quiz_questions[q_id-1]
                    correct_option = f"{option_letters[question['correct_answer']]}) {question['options'][question['correct_answer']]}"
                    if answer == correct_option:
                        correct_count += 1
            ...
            if submitted_count > 0:
                ...
                with col1:
                    st.metric("Questions Answered", f"{submitted_count}/20")
                with col2:
                ...
                # Progress bar
                progress = submitted_count / 20
                st.progress(progress)
                st.markdown(f"**Progress:** {submitted_count}/20 questions completed ({progress*100:.1f}%)")

                if submitted_count == 20:
                    st.success("🎉 Congratulations! You've completed all 20 questions!")
                    st.balloons()

                    # Final score analysis
                    final_percentage = (correct_count / 20) * 100
                    ...
                    if st.button("🔄 Reset All Questions", type="primary"):
                        ...
                        st.rerun()
                elif submitted_count >= 10:
                    st.info(f"🎯 Excellent progress! {20 - submitted_count} questions remaining.")
                    if st.button("🔄 Reset All Questions"):
                        st.session_state.sample_quiz_answers = {}
                        st.session_state.sample_quiz_submitted = {}
                        st.rerun()
                elif submitted_count >= 5:
                    st.info(f"🎯 Good progress! {20 - submitted_count} questions remaining.")
                    if st.button("🔄 Reset All Questions"):
                        st.session_state.sample_quiz_answers = {}
                        st.session_state.sample_quiz_submitted = {}
                        st.rerun()
                ...
                if subject_performance:
                    ...
                    for subject, (correct, total) in subject_performance.items():
        ...
        # Display active quiz if started
        if st.session_state.get('quiz_started', False) and not st.session_state.get('quiz_completed', False):
            ...
            if current_q < len(questions):
                ...
                st.markdown("**🎯 Choose your answer:**")
                option_letters = ['A', 'B', 'C', 'D']
                formatted_options = [f"{option_letters[i]}) {option}" for i, option in enumerate(question['options'])]

                answer = st.radio(
                    "Select your answer:",
                    formatted_options,
                    key=f"quiz_page_q_{current_q}",
                    index=None
                )
    ...
    with tab4:
        ...
        with col1:
            st.metric("📄 Documents Uploaded", len(st.session_state.processed_files))
        with col2:
        ...
        with col3:
            if st.session_state.chunks:
                ...
                st.metric("📊 Total Words Processed", "0")
