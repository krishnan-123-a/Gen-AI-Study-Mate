"""
StudyMate - Clear Color Version
Perfect visibility with high contrast colors
"""
...
def main():
    """Main application with clear, high-contrast colors"""
    # Page configuration
    st.set_page_config(
    ...
    # Custom CSS for clear, high-contrast design
    st.markdown("""
    <style>
    ...
    /* Feature cards - white background with dark text */
    .feature-card {
        background: #ffffff;
    ...
    /* Answer container - light blue background */
    .answer-container {
        background: #f8f9fa;
    ...
    /* Source container - light green background */
    .source-container {
        background: #f1f8e9;
    ...
    /* Status card - clean white with border */
    .status-card {
        background: #ffffff;
    ...
    <div class="main-header">
        ...
        <p>Transform your PDFs into an interactive learning experience with AI-powered Q&A</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col1:
        ...
        <div class="feature-card">
            ...
            <p>Upload your PDF study materials to get started. Supports multiple files with robust error handling.</p>
        </div>
        """, unsafe_allow_html=True)
                        ...
                        with st.expander("📄 View Referenced Content", expanded=False):
                            for i, chunk in enumerate(relevant_chunks, 1):
                                ...
                                <div class="source-container">
                                    ...
                                    <p>{chunk['text'][:400]}{'...' if len(chunk['text']) > 400 else ''}</p>
                                </div>
                                """, unsafe_allow_html=True)
