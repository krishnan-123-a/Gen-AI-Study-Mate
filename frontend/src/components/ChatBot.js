...
function ChatBot() {
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content: "Hi! I'm your Gen-AI Study Mate 👋 Ask me anything — a concept, a topic, a problem. I'm here to help you learn!",
    },
  ]);
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { role: 'assistant', content: '⚠️ Sorry, I ran into an issue. Please try again.' },
      ]);
    } finally {
      setLoading(false);
    }
